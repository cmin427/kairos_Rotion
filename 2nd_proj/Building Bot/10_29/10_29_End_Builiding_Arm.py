...
while not completed:
    ...
    if box_center:
        ...
        print('OPEN')
        mc.set_eletric_gripper(1)  # 그립퍼 전원 켜기
        mc.set_gripper_value(30, 20)  # 그립퍼 열기
        time.sleep(2)
        ...
        # 잡은 다음에 안정된 위치로 이동시킴
        mc.send_coords([(-80.9), (-102.3), 346, (-170), 17.77, 87.55], 20, 0)
        print('안정된 위치로 이동')
        time.sleep(5)
        ...
        mc.send_angles([(-55.89),(-93.69),(35.59),(-24.87), 89.56, joint6_angle+angle],20)
        print('1번째-1')
        time.sleep(10)
        ...
        print('OPEN')
        mc.set_eletric_gripper(1)  # 그립퍼 전원 켜기
        mc.set_gripper_value(100, 8)  # 그립퍼 열기
        time.sleep(3)
       ...
       # gripper 작동
        ...
        mc.send_angles([(-58.35),(-86.13),(34.71),(-28.38), 89.56, joint6_angle+angle],20)
        print('1번째-3')
        time.sleep(10)
